      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p>
              If you have any questions about these Terms, please contact us at <a href="mailto:contact@buildmcp.space" className="text-[#E1623D] hover:text-[#E1623D]/80">contact@buildmcp.space</a>.
            </p>
          </div>
        </div>
      </div>
